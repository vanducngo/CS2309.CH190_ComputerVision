...
_C.ADAPTER.IMPROVEMENT = CN()
_C.ADAPTER.IMPROVEMENT.IS_USE_IMPROVE = True
_C.ADAPTER.IMPROVEMENT.SHOULD_WAINT_ALL_CLASS_HAVE_SAMPLE = False
_C.ADAPTER.IMPROVEMENT.USE_QUEUE = False
_C.ADAPTER.IMPROVEMENT.USE_ADAPTIVE_AGING = False
_C.ADAPTER.IMPROVEMENT.USE_AWARE_SCORE = False
_C.ADAPTER.IMPROVEMENT.USE_AGING_PER_BATCH = False
_C.ADAPTER.IMPROVEMENT.BASE_AGING_SPEED = 8.0
_C.ADAPTER.IMPROVEMENT.LAMBDA_D = 0.5
_C.ADAPTER.IMPROVEMENT.AGE_FACTOR = 5.0

# Wait for classes
_C.ADAPTER.IMPROVEMENT.WAIT_FOR_CLASSES = True
_C.ADAPTER.IMPROVEMENT.WAIT_CLASS_RATIO = 0.5
_C.ADAPTER.IMPROVEMENT.WAIT_MAX_INSTANCES = 640
